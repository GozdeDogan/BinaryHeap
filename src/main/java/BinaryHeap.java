...
public class BinaryHeap<E extends Comparable> extends BinaryTree<E> implements Queue<E>{
    ...
    public boolean contains(Object target) {
        E returnedValue = find(root, (E) target);
     ...
     *         the item
     */
    private BinaryTree.Node<E> remove(BinaryTree.Node<E> localRoot, E item) {
        if (localRoot == null) {
    ...
    /**
     * Queue interface'inden gelen metotlar
     */
    ...
    /**
     * java nin zorlamasi uzerine implement ettigim ama kullanmadigim metotlar
     */

    /**
     * Iterator<E> return eden iterator metodu
     * @return
     */
